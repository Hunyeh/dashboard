...
import { colorMappingData, ColorMappingPrimaryXAxis, ColorMappingPrimaryYAxis, rangeColorMapping } from '../../data/data/dummy';
...
const ColorMapping = () => {
  ...
  return (
    <div className="m-4 md:m-10 mt-24 p-10 bg-white dark:bg-secondary-dark-bg rounded-3xl">
      <ChartsHeader category='Color Mapping' title='USE CLIMATE - WEATHER BY MONTH' />
