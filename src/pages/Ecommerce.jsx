...
import { earningData, SparklineAreaData, ecomPieChartDat } from '../data/data/dummy';
        ...
        lg:w-80 p-8 pt-9 m-3 bg-hero-pattern bg-no-repeat bg-cover bg-center'> 
          <div className='flex justify-between items-center'>
            <div>
              ...
              <p className='text-2xl'>$69,420.69</p>
            </div>
          </div>
          <div className='mt-6'>
            <Button
        ...
        <div className='bg-white dark:text-gray-200 dark:bg-secondary-dark-bg m-3 p-4 rounded-2xl md:w-780'>
            ...
            <div className='mt-10 flex gap-10 flex-wrap justify-center'>
              <div className='border-r-l border-color m-4 pr-10'>
                <div>
                  <p>
                    <span className='text-3xl font-semibold'>$100,724</span>
                ...
                <div className='mt-8'>
                  <p>
                    <span className='text-3xl font-semibold'>$45,982</span>
                  </p>
